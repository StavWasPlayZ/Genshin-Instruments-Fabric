...
public class DjemDjemDrumScreen extends InstrumentScreen {
    public static final ResourceLocation INSTRUMENT_ID = GInstrumentMod.loc("djem_djem_drum");
    ...
    protected void init() {
        ...
        layout1.setPosition((width - layout1.getWidth() + 80) / 2, (int)(height * .8f));
        layout2.setPosition((width - layout2.getWidth() + 80) / 2, layout1.getY() - layout1.getHeight() - 10);
