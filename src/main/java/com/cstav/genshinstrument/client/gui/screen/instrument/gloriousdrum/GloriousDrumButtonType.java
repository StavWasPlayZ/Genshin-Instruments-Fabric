...
import com.cstav.genshinstrument.client.keyMaps.InstrumentKeyMappings.GlriousDrumKeys;
...
public enum GloriousDrumButtonType {
    ...
    private GloriousDrumButtonType(NoteSound sound, String transKey) {
        this.sound = sound;
    ...
    public GlriousDrumKeys getKeys() {
