...
public abstract class GridInstrumentScreen extends InstrumentScreen {
    ...
    @Override
    public void renderInstrument(PoseStack poseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        super.renderInstrument(poseStack, pMouseX, pMouseY, pPartialTick);
    }
